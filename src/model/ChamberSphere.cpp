...
void ChamberSphere::update_gradient(
  ...
  auto volume = y[global_var_ids[4]];
  auto time = y[global_var_ids[5]];
  ...
  auto dvolume = dy[global_var_ids[4]];
  auto dt = dy[global_var_ids[5]]; 
  ...
  double dradius = pow((4 * M_PI / (3 * volume)), (2.0 / 3.0)) * (dvolume / (4 * M_PI));
  ...
  jacobian.coeffRef(global_eqn_ids[0], global_param_ids[0]) = pow(M_PI, -2.3333333333333335)*pow(volume, -5.333333333333333)*(pow(M_PI, 0.66666666666666663)*(-1.0*pow(M_PI, 0.66666666666666663)*dvolume*eta*pow(volume, 2.0)*(6.3209876543209873*pow(M_PI, 4.0)*pow(radius0, 12) - pow(volume, 4.0))*pow(1.0/volume, 0.66666666666666663) - 0.90856029641606983*pow(M_PI, 0.66666666666666674)*pow(volume, 3.6666666666666665)*(7.1111111111111107*pow(M_PI, 2.0)*pow(radius0, 6) - 4*pow(volume, 2.0))*(pow(M_PI, 0.66666666666666663)*W1*pow(radius0, 2) + 0.82548181222365669*W2*pow(volume, 0.66666666666666663)) + 0.90856029641606983*pow(M_PI, 1.3333333333333335)*pow(radius0, 2)*tau*pow(volume, 5.6666666666666661)) + pow(M_PI, 2.3333333333333335)*ddradius*pow(radius0, 4)*rho*pow(volume, 5.333333333333333))/pow(radius0, 4);
